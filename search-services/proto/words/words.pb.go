...
const file_proto_words_words_proto_rawDesc = "" +
	"\n" +
	"\x17proto/words/words.proto\x12\x05words\"&\n" +
	"\fWordsRequest\x12\x16\n" +
	"\x06phrase\x18\x01 \x01(\tR\x06phrase\"\"\n" +
	"\n" +
	"WordsReply\x12\x14\n" +
	"\x05words\x18\x01 \x03(\tR\x05words29\n" +
	"\x05Words\x120\n" +
	"\x04Norm\x12\x13.words.WordsRequest\x1a\x11.words.WordsReply\"\x00B\x1cZ\x1asearch-service/proto/wordsb\x06proto3"
...
var file_proto_words_words_proto_depIdxs = []int32{
	0, // 0: words.Words.Norm:input_type -> words.WordsRequest
	1, // 1: words.Words.Norm:output_type -> words.WordsReply
